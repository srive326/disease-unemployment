...
I'm going to explore disease rate over time in Florida and also see if there's a relationship between disease rates and unemployment rates in Florida. 
...
Compare us disease rate to us unemployment rate 


```{r}

us_disease <- us_disease %>% filter(disease != "Polio")
us_disease <- mutate(us_disease, disease_rate = (count/population)*100000)
us_disease
